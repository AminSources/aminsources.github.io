...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1289: Date.now,
      _1291: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1292: s => {
      ...
      _1294: () => typeof dartUseDateNowForTicks !== "undefined",
      _1295: () => 1000 * performance.now(),
      _1296: () => Date.now(),
      _1297: () => {
      ...
      _1303: x0 => x0.deref(),
      _1309: () => globalThis.WeakRef,
      _1314: s => JSON.stringify(s),
      _1315: s => printToConsole(s),
      _1316: (o, p, r) => o.replaceAll(p, () => r),
      _1318: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1319: s => s.toUpperCase(),
      _1320: s => s.trim(),
      _1321: s => s.trimLeft(),
      _1322: s => s.trimRight(),
      _1323: (string, times) => string.repeat(times),
      _1324: Function.prototype.call.bind(String.prototype.indexOf),
      _1325: (s, p, i) => s.lastIndexOf(p, i),
      _1326: (string, token) => string.split(token),
      _1327: Object.is,
      _1328: (a, i) => a.push(i),
      _1332: a => a.pop(),
      _1333: (a, i) => a.splice(i, 1),
      _1334: (a, s) => a.join(s),
      _1335: (a, s, e) => a.slice(s, e),
      _1337: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
      _1338: a => a.length,
      _1340: (a, i) => a[i],
      _1341: (a, i, v) => a[i] = v,
      ...
      _1346: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1347: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1348: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1349: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1350: (o, start, length) => new Int32Array(o.buffer, o.byteOffset + start, length),
      _1352: (o, start, length) => new BigInt64Array(o.buffer, o.byteOffset + start, length),
      _1353: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1354: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1355: (t, s) => t.set(s),
      _1357: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1359: o => o.buffer,
      _1360: o => o.byteOffset,
      _1361: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1362: (b, o) => new DataView(b, o),
      _1363: (b, o, l) => new DataView(b, o, l),
      _1364: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1365: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1366: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1367: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1368: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1369: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1370: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1371: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1372: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1373: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1374: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1375: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1378: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1379: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1380: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1381: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1382: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1383: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1396: () => new XMLHttpRequest(),
      _1397: (x0,x1,x2) => x0.open(x1,x2),
      _1398: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
      _1399: x0 => x0.abort(),
      _1400: (x0,x1) => x0.send(x1),
      _1401: x0 => x0.send(),
      _1402: x0 => x0.getAllResponseHeaders(),
      ...
      _1409: (handle) => clearTimeout(handle),
      _1410: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1411: (handle) => clearInterval(handle),
      _1412: (c) =>
      ...
      _1435: (x0,x1) => x0.exec(x1),
      _1436: (x0,x1) => x0.test(x1),
      _1437: x0 => x0.pop(),
      _1439: o => o === undefined,
      _1441: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1443: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1444: o => o instanceof RegExp,
      _1445: (l, r) => l === r,
      _1446: o => o,
      _1447: o => o,
      _1448: o => o,
      ...
      _1450: o => o.length,
      _1452: (o, i) => o[i],
      _1453: f => f.dartFunction,
      _1454: () => ({}),
      _1455: () => [],
      _1457: () => globalThis,
      _1458: (constructor, args) => {
      ...
      _1460: (o, p) => o[p],
      _1461: (o, p, v) => o[p] = v,
      _1462: (o, m, a) => o[m].apply(o, a),
      _1464: o => String(o),
      _1465: (p, s, f) => p.then(s, f),
      _1466: o => {
      ...
      _1467: o => [o],
      _1468: (o0, o1) => [o0, o1],
      _1469: (o0, o1, o2) => [o0, o1, o2],
      _1470: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1484: x0 => x0.index,
      _1486: x0 => x0.flags,
      _1487: x0 => x0.multiline,
      _1488: x0 => x0.ignoreCase,
      _1489: x0 => x0.unicode,
      _1490: x0 => x0.dotAll,
      _1491: (x0,x1) => x0.lastIndex = x1,
      _1492: (o, p) => p in o,
      _1493: (o, p) => o[p],
      _1496: x0 => x0.random(),
      _1499: () => globalThis.Math,
      _1500: Function.prototype.call.bind(Number.prototype.toString),
      _1501: Function.prototype.call.bind(BigInt.prototype.toString),
      _1502: Function.prototype.call.bind(Number.prototype.toString),
      _1503: (d, digits) => d.toFixed(digits),
      _1507: () => globalThis.document,
      _1527: x0 => x0.src,
      _1528: (x0,x1) => x0.src = x1,
      _1529: x0 => x0.naturalWidth,
      _1530: x0 => x0.naturalHeight,
      _1546: x0 => x0.status,
      _1547: (x0,x1) => x0.responseType = x1,
      _1549: x0 => x0.response,
      _1587: x0 => x0.readyState,
      _1589: (x0,x1) => x0.timeout = x1,
      _1591: (x0,x1) => x0.withCredentials = x1,
      _1592: x0 => x0.upload,
      _1593: x0 => x0.responseURL,
      _1594: x0 => x0.status,
      _1595: x0 => x0.statusText,
      _1597: (x0,x1) => x0.responseType = x1,
      _1598: x0 => x0.response,
      _1610: x0 => x0.loaded,
      _1611: x0 => x0.total,
      _3381: () => globalThis.window,
      _3443: x0 => x0.navigator,
      _3832: x0 => x0.userAgent,
...
", event: ",
"(products api) Error on Status Code: ",
"Somethig went wrong, please check api server or your internet connection.",
"(products api) Error on Catch: ",
"Somethig went wrong, please check sources or your internet connection.",
"https://retoolapi.dev/UfWG4G/portfolio-products",
"GET",
"bytes",
"stream",
"json",
...
"options",
"skipCount",
"(contact api) Error on Status Code: ",
"Failed to send! please check your internet connection.",
"(contact api) Error on Catch: ",
"Failed to send! please check source or your internet connection.",
"https://retoolapi.dev/bW4ifR/web-contact",
"POST",
"alwaysNew",
"cachedFactory",
"constant",
...
"© 2025 AminSources. All rights reserved.",
"_bloc",
"AutovalidateMode.",
"onUserInteraction",
"onUnfocus",
...
"_theme",
"swipe",
"https://github.com/aminsources",
"https://www.instagram.com/m_amin_farshbaf/",
...
"feather_icons",
"PlayfairDisplay",
"هر کجا که هستید، با من تماس بگیرید، من به شما در رسیدن به اهدافتان کمک خواهم کرد.",
...
"adaptive",
"lib/assets/images/personal_picture_square.png",
"https://img.icons8.com/ios/75/flutter--v1.png",
"https://img.icons8.com/ios/500/dart-language--v1.png",
"https://img.icons8.com/ios/75/python--v1.png",
"https://img.icons8.com/ios/75/figma--v1.png",
"Dart",
"Python",
"Figma",
"noRepeat",
...
"دانلود رزومه",
"Download CV",
"CV file not available for download yet!",
"من یک توسعه‌دهنده و دانشجوی پرشور هستم که علاقه زیادی به توسعه دارم. من عاشق ایجاد برنامه‌های پویا و واکنش‌گرا هستم که تجربیات کاربری عالی ارائه می‌دهند. سفر من در دنیای فناوری هیجان‌انگیز بوده است و من همیشه مشتاق یادگیری فناوری‌های جدید و بهبود مهارت‌هایم هستم.",
"I am a passionate developer and student with a keen interest in development. I love creating dynamic and responsive applications that provide great user experiences. My journey in the tech world has been exciting, and I am always eager to learn new technologies and improve my skills.",
"cover",
"BoxFit.",
"_scrollAwareContext",
...
"_handlePointerEvent",
"_gestureRecognizers",
"یک توسعه دهنده و دانش اموز",
"A Developer and Student",
"درباره من",
"About Me",
"https://corsproxy.io/?url=",
"Failed to open link",
"https://img.icons8.com/ios-glyphs/100/nothing-found.png",
"No products found!.",
...
"alignment",
"طراحی رابط‌ها و تجربیات کاربرپسند با استفاده از Figma.",
"Designing user-friendly interfaces and experiences using Figma.",
"توسعه برنامه‌های دسکتاپ برای پلتفرم‌های مختلف با استفاده از Dart و Flutter.",
"Developing desktop applications for various platforms using Dart and Flutter.",
"ایجاد برنامه‌های موبایل چند پلتفرمی با استفاده از Dart و Flutter.",
"Creating cross-platform mobile applications using Dart and Flutter.",
"ساخت وب‌سایت‌های واکنش‌گرا و پویا با استفاده از Dart و Flutter.",
"Building responsive and dynamic websites using Dart and Flutter.",
"طراحی رابط کاربری",
"UI/UX Design",
"توسعه دسکتاپ",
"Desktop Development",
...
"Mobile",
"همه",
"برخی از آخرین پروژه‌های من را بررسی کنید",
"Check out some of my latest projects",
"نمونه کار",
"Portfolio",
"من خدمات متنوعی را برای کمک به شما در رسیدن به اهدافتان ارائه می‌دهم.",
"I offer a variety of services to help you achieve your goals.",
"خدمات",
"Services",
"lib/assets/images/background_shadow.png",
"lib/assets/images/personal_picture_circle.png",
"+2 ",
"+5 ",
"پروژه ها",
"Projects",
